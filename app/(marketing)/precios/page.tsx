      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {planes.map((plan, index) => (
            ...
            >
              ...
              <a
                href={plan.nombre === 'Empresarial' ? '/contacto' : '/register'}
              ...
              >
                {plan.nombre === 'Empresarial' ? 'Contactar Ventas' : 'Registro Gratuito'}
              </a>
            </div>
          ))}
        </div>
        ...
        <div className="bg-green-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-green-100 mb-6 text-lg">
            Regístrate gratis y comienza a usar AíDER hoy mismo. Sin compromisos, sin tarjeta de crédito.
          </p>
